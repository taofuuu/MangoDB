...
`password` column holds a plain string rather than a hash. Everything that
route needs lives in `app/dev/`; do not import from it. It goes away when the
real login page lands.
