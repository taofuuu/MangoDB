...
// proposal (proposal.sender_id) or as the receiver who posted the listing
// that proposal answers (proposal.listing.company_id) — an account_type of
